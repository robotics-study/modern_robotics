...
\begin{bmatrix} \dot\theta_1 \\ \dot\theta_2 \end{bmatrix}'/>
            ...
            <T
                ...
                ko={<p>
                    ...
                    수 있는 속도의 <em>전부</em>이고, 점선 타원은 "같은 노력" 원이 옮겨진 모습, 곧 아래에서 다시 만날{" "}
            ...
            <T
                ...
                ko={<p>
                    ...
                    오른쪽에 <InlineMath math='T^{-1}'/> 을 곱하자. 뒤쪽 인자들이 항마다 소거된다:
                </p>}
            />
            <div className="overflow-x-auto">
...
\end{bmatrix}'/>
            ...
            <T
                ...
                ko={<p>
                    ...
                    위로 밀 뿐이라 순수 병진 <InlineMath math='(0, 0, 0, 0, 0, 1)'/> 이다. <strong>Body Jacobian</strong>{" "}
            ...
            <T
                en={<p>
                    This is the screw axis of joint <InlineMath math='i'/> seen from the <em>displaced
                    end-effector frame</em>, unaffected by the joints closer to the base. The two Jacobians are related by
                    the adjoint map,
                </p>}
                ko={<p>
...
\qquad \omega_b = A(r)\,\dot r'/>
            ...
            <T
                ...
                ko={<p>
                    둘째, 역질문의 예고다. 원하는 twist <InlineMath math='\mathcal{V}'/> 가 주어지면 어떤{" "}
...
\qquad A = JJ^{\mathsf T}'/>
            ...
            <T
                en={<p>
                    This is the equation of an ellipsoid: the <strong>manipulability ellipsoid</strong>. Its
                ...
                ko={<p>
                    이것은 ellipsoid(타원체)의 방정식, 곧 <strong>Manipulability Ellipsoid</strong>다. 주축은{" "}
            ...
            <T
                ...
                ko={<p>
                    ...
                    <InlineMath math='\ell_\text{max}/\ell_\text{min}'/>은 Singularity로부터의 거리를 측정하며,{" "}
            ...
            <T
                en={<p>
                    ...
                    versa. This is the suitcase carrier's bargain from the statics section.
                </p>}
                ko={<p>
                    ...
                    <InlineMath math='A'/> 와 고유벡터는 같고 반축은 역수 <InlineMath math='1/\sqrt{\lambda_i}'/> 다.
