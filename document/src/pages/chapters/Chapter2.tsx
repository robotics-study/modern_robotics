        ...
        <>
            <T
                ...
                ko={<p>
                    ...
                    <strong>configuration</strong> — 로봇의 <em>모든</em> 점의 위치를 지정하는 것 — 이다. 문은 숫자
            ...
            <T
                en={<p>
                    ...
                    <InlineMath math='B'/> on a circle — one angle <InlineMath math='\varphi_{AB}'/> suffices
                    ...
                    coordinates and two independent constraints — nothing changes. Try it below.
                </p>}
                ko={<p>
                    ...
                    두 제약이 <InlineMath math='C'/> 를 두 원의 교점 — heads 또는 tails, 딱 <em>두</em> 개의 이산적
                    후보 — 에 못박는다(<strong>+0</strong>). 점을 더 추가해도 좌표 둘과 독립 제약 둘이 함께 생겨
            ...
            <T
                ...
                ko={<p>
                    ...
                    <InlineMath math='A'/> 중심의 구면 위 — 위도와 경도(+2) — 에, <InlineMath math='C'/> 는 두 구가
            ...
            <T
                ...
                ko={<p>
                    ...
                    <InlineMath math='J'/> 개 — 관절 <InlineMath math='i'/> 가 자유도 <InlineMath math='f_i'/> 를
                    제공 — 로 이루어진 메커니즘을 보자. 움직이는 링크들이 <InlineMath math='m(N-1)'/> 의 자유도를
            ...
            <T
                en={<p>
                    Many C-spaces are <strong>Cartesian products</strong> of simpler ones — read the factors off
                    the mechanism: a planar rigid body has C-space{" "}
                    ...
                    <InlineMath math='S^1 \times S^1 = T^2'/> — the <strong>torus</strong>, not the sphere{" "}
                ...
                ko={<p>
                    ...
                    <InlineMath math='3+2+1'/> 셈), 2R 팔은 <InlineMath math='S^1 \times S^1 = T^2'/> —{" "}
                    구면 <InlineMath math='S^2'/> 이 아니라 <strong>torus</strong> 다. 아래에서 두 관절각은 말
                    그대로 도넛 위에 산다.
                </p>}
            />
            <TorusCSpace3D/>
            <T
                en={<p>
                    ...
                    <InlineMath math='n'/> coordinates — latitude and longitude on a sphere. Its price is{" "}
            ...
            <T
                en={<p>
                    The other fix — the one this book adopts — is an <strong>implicit representation</strong>:
                    ...
                    numbers with six constraints — the <strong>rotation matrix</strong> — for the three
                    orientation freedoms.
                </p>}
                ko={<p>
                    다른 해결책 — 이 책이 택하는 쪽 — 은 <strong>암시적 표현</strong>이다: 공간을 더 높은 차원의
            ...
            <T
                ...
                ko={<p>
                    ...
                    4R 체인"으로 보자. 그 요구 하나가 관절각 네 개에 대한 방정식 세 개 —{" "}
                    <strong>루프 닫힘(loop-closure) 방정식</strong> — 가 된다:
                </p>}
            />
            <div className="overflow-x-auto">
...
\quad\Longrightarrow\quad A(\theta)\,\dot\theta = 0,\;\; A(\theta) \in \mathbb{R}^{k \times n}'/>
            ...
            <T
                en={<p>
                    ...
                    configuration constraint — holonomic. But not every Pfaffian constraint integrates. The
                ...
                ko={<p>
                    ...
                    <strong>적분 가능</strong>하다 — holonomic 이다. 그러나 모든 Pfaffian 제약이 적분되는 것은
...
\begin{bmatrix} 1 & 0 & 0 & -r\cos\phi \\ 0 & 1 & 0 & -r\sin\phi \end{bmatrix} \dot q = 0'/>
            ...
            <T
                en={<p>
                    ...
                    <strong>task space</strong> is where the task naturally lives — chosen by the task,
                    ...
                    actually reach — determined by the robot's structure, independent of any task.
                </p>}
                ko={<p>
